...
try:  # pragma: no cover - depends on install method
    ...
    # An autogenerated GitHub branch ZIP contains neither .git metadata nor
    # the generated file shipped in an sdist. It must not impersonate the old
    # 2.1 development tree forever. Installable artifacts always take the
    # branch above; this value identifies only an unversioned source snapshot.
